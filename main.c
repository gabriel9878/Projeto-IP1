...
void init( Administrador admt[], Funcionario func[],Produto prodt[], int *admtCadQtd, int *prodtCadQtd, int *funcCadQtd){
...
int main()
    {
        ...
        init(admt,func,prodt,&admtCadQtd,&prodtCadQtd,&funcCadQtd);
        ...
        checkLoginAdministrador(admt,login,senha,&admtCadQtd);
