...
//-------------------------------[<FUNÇÕES & PROCEDIMENTOS: ADMINISTRADOR>]----------------------------------//
    ...
    void impressProduto (Administrador admt[], Funcionario func[], Produto prodt[], char login[], int *acq, int *fcq, int *pcq, int *amax, int *fmax, int *pmax);
    void impressAdministrador (Administrador admt[], Funcionario func[], Produto prodt[], char login[], int *acq, int *fcq, int *pcq, int *amax, int *fmax, int *pmax);
    void impressFuncionario (Administrador admt[], Funcionario func[], Produto prodt[], char login[], int *acq, int *fcq, int *pcq, int *amax, int *fmax, int *pmax);
    ...
    void atualProduto (Administrador admt[], Funcionario func[], Produto prodt[], char login[], int *acq, int *fcq, int *pcq, int *amax, int *fmax, int *pmax);
    void excProduto (Administrador admt[], Funcionario func[], Produto prodt[], char login[], int *acq, int *fcq, int *pcq, int *amax, int *fmax, int *pmax);
    int checkLoginAdministrador (Administrador admt[], char login[], char senha[], int *acq);
    void loginFuncionario (Administrador admt[], Funcionario func[], Produto prodt[], char login[], int *acq, int *fcq, int *pcq, int *amax, int *fmax, int *pmax);
    void menuFuncionario (Administrador admt[], Funcionario func[], Produto prodt[], char login[], int *acq, int *fcq, int *pcq, int *amax, int *fmax, int *pmax);
    ...
    void atualProdtCod (Administrador admt[], Funcionario func[], Produto prodt[], char login[], int *acq, int *fcq, int *pcq, int *amax, int *fmax, int *pmax);
    void atualProdtNome (Administrador admt[], Funcionario func[], Produto prodt[], char login[], int *acq, int *fcq, int *pcq, int *amax, int *fmax, int *pmax);
    void excProdtCod (Administrador admt[], Funcionario func[], Produto prodt[], char login[], int *acq, int *fcq, int *pcq, int *amax, int *fmax, int *pmax);
    void excProdtNome (Administrador admt[], Funcionario func[], Produto prodt[], char login[], int *acq, int *fcq, int *pcq, int *amax, int *fmax, int *pmax);
    ...
    void menuPrincipal(Administrador admt[], Funcionario func[], Produto prodt[], char login[], int *acq, int *fcq, int *pcq, int *amax, int *fmax, int *pmax)
    {
        ...
        do
        {
            ...
            case 1:
                ...
                break;
            case 2:
                loginFuncionario (admt, func, prodt, login, acq, fcq, pcq, amax, fmax, pmax);
                break;
...
//---------------------------------------[<PROCEDIMENTOS: ADMINISTRADOR>]-------------------------------------//
    ...
    void menuAdministrador(Administrador admt[], Funcionario func[], Produto prodt[], char login[], int *acq, int *fcq, int *pcq, int *amax, int *fmax, int *pmax)
    {
        ...
        case 3:
            cadProduto (admt, func, prodt, login, acq, fcq, pcq, amax, fmax, pmax);
            break;
        ...
        case 5:
            impressAdministrador (admt, func, prodt, login, acq, fcq, pcq, amax, fmax, pmax);
            break;

        case 6:
            impressFuncionario (admt, func, prodt, login, acq, fcq, pcq, amax, fmax, pmax);
            break;

        case 7:
            impressProduto (admt, func, prodt, login, acq, fcq, pcq, amax, fmax, pmax);
            break;

        case 8:
            atualProduto (admt, func, prodt, login, acq, fcq, pcq, amax, fmax, pmax);
            break;

        case 9:
            excProduto (admt, func, prodt, login, acq, fcq, pcq, amax, fmax, pmax);
            break;

        case 0:
            menuPrincipal (admt, func, prodt, login, acq, fcq, pcq, amax, fmax, pmax);
            break;
    ...
    void loginFuncionario (Administrador admt[], Funcionario func[], Produto prodt[], char login[], int *acq, int *fcq, int *pcq, int *amax, int *fmax, int *pmax)
    {
        ...
        for(i = 0; i < *acq; i++)
        {
            ...
            {
                menuFuncionario (admt, func, prodt, login, acq, fcq, pcq, amax, fmax, pmax);
            }
            else
            {
    ...
    void cadFuncionario (Administrador admt[], Funcionario func[], Produto prodt[], char login[], int *acq, int *fcq, int *pcq, int *amax, int *fmax, int *pmax)
    {
        ...
        while(i < *fmax)
        {
            ...
            printf("\n'                                                                    '\n");
            printf("'NAO & SAIR do SISTEMA: DIGITE [<3>].                                  '\n");
            printf("\n'                                                                    '\n");
            printf("'\n--------------------------------------------------------------------'\n");
    ...
    void atualProduto (Administrador admt[], Funcionario func[], Produto prodt[], char login[], int *acq, int *fcq, int *pcq, int *amax, int *fmax, int *pmax)
    {
        ...
        {
        case 1:
            atualProdtCod (admt, func, prodt, login, acq, fcq, pcq, amax, fmax, pmax);
            break;

        case 2:
            atualProdtNome (admt, func, prodt, login, acq, fcq, pcq, amax, fmax, pmax);
            break;
    ...
    void excProduto (Administrador admt[], Funcionario func[], Produto prodt[], char login[], int *acq, int *fcq, int *pcq, int *amax, int *fmax, int *pmax)
    {
        ...
        {
        case 1:
            excProdtCod (admt, func, prodt, login, acq, fcq, pcq, amax, fmax, pmax);
            break;

        case 2:
            excProdtNome (admt, func, prodt, login, acq, fcq, pcq, amax, fmax, pmax);
            break;
...
int main()
    {
        ...
        //cadProduto (admt, func, prodt, login, &admtCadQtd, &funcCadQtd, &prodtCadQtd, &ADM_MAX, &FUNC_MAX, &PROD_MAX);
