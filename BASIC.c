...
void loginAdministrador(Administrador admt[],Produto prodt[],Caixa cx[],int *acq,int *ccq,int *pcq);
void menuPrincipal(Administrador admt[],Produto prodt[],Caixa cx[],int *acq,int *ccq,int *pcq);
void menuAdministrador(Administrador admt[],Produto prodt[],Caixa cx[],char lgn[],int *acq,int *ccq,int *pcq);
void excProduto(Produto prodt[],int *pcq);
void atualProduto(Produto prodt[],int *pcq);
void impressProduto(Produto prodt[],int *pcq);
void meetProduto(Produto prodt[], int *pcq);
void cadProduto(Produto prodt[],int *pcq);




void loginAdministrador(Administrador admt[],Produto prodt[],Caixa cx[],int *acq,int *ccq,int *pcq) //REALIZA O LOGIN O ADMINISTRADOR.
{
    ...
    for(i = 0; i<*acq; i++)
    {
        ...
        if((strcmp((admt[i]).user,login) == 0) && (strcmp((admt[i]).senha,senha) == 0))  //Checa se existe dentro do array o login e a senha digitados pelo usuario.
        {
            ...
            menuAdmininistrador(admt,prodt,cx,login,*acq,*ccq,*pcq);
        ...
        else
        {
            ...
            loginAdministrador(admt,prodt,cx,*acq,*ccq,*pcq);
        }
...
//FUNÇÃO MENU PRINCIPAL
    ...
    void menuPrincipal(Administrador admt[],Produto prodt[],Caixa cx[],int *acq,int *ccq,int *pcq) //MOSTRA O MENU PRINCIPAL;
    {
